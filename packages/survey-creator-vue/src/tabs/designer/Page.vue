...
const props = defineProps<{ creator: CreatorBase, survey: SurveyModel, page: PageModel }>();
// useBase(() => new PageAdorner(props.creator, props.page));
const model = useCreatorModel(() => new PageAdorner(props.creator, props.page), [() => props.page]);
</script>
