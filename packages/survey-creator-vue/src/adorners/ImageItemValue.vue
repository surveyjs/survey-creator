      ...
      <template v-if="!adorner.isNew && !adorner.isUploading">
        ...
        <div v-if="adorner.canRenderControls" class="svc-context-container svc-image-item-value-controls">
          <span
            ...
            :aria-label="undefined"
          >
            <sv-svg-icon :iconName="'icon-file'" :size="24" :title="adorner.selectFileTitle"></sv-svg-icon>
          </span>
          <span
            ...
            :aria-label="undefined"
          >
            <sv-svg-icon :iconName="'icon-delete'" :size="24" :title="adorner.removeFileTitle"></sv-svg-icon>
          </span>
        </div>
      </template>
