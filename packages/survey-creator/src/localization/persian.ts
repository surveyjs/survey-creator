...
var persianStrings = {
  ...
  "ed": {
    "propertyGridFilteredTextPlaceholder" : 'اینجا بنویسید...',
  ...
  "pe": {
    ...
    "displayRateDescriptionsAsExtremeItems" : 'نمایش توضیحات رتبه بندی به جای عدد آن ',
    "hideNumber" : 'پنهان کردن عدد',
    "useDisplayValuesInTitle" : 'از مقادیر نمایش داده شده در عنوان استفاده شود',
    "showOptionsCaption" : 'نمایش عنوان گزینه ها',
    "allowEmptyResponse" : 'پاسخ خالی مجاز است',
    "hideIfChoicesEmpty" : 'پنهان سازی در صورتی که گزینه خالی بود',
    "autoGrow" : 'رشد خودکار(فلکس)',
    "showClearButton" : 'نمایش دکمه ی پاک کردن',
    "allowClear" : 'محل امضا خالی بماند',
    "showHeader" : 'نمایش عنوان ها',
    "hideIfRowsEmpty" : 'پنهان سازی سطر های خالی',
    "showColumnHeader" : 'نمایش سرستون ها',
    "showNumber" : 'نمایش عددها',
    "autoGrowComment" : 'رشد خودکار نظرات (فلکس)',
    "focusOnFirstError" : 'حالت focus روی خطای اول',
    "includeIntoResult" : 'در نتیجه لحاظ شود',
    "logoWidth" : 'عرض لوگو( در css مورد قبول باشد)',
    "logoHeight" : 'طول لوگو( در css مورد قبول باشد)',
    "logo" : 'لوگو ی نظرسنجی ( به صورت آدرس یا فرمت base64 )',
    "showPreviewBeforeComplete" : 'پیش نمایش نظرسنجی قبل از تکمیل آن',
    "maxTextLength" : 'حداکثر طول پاسخ',
    "maxOthersLength" : 'حداکثر طول نظر',
    "textUpdateMode" : ' بروز رسانی مقدار متن سوال',
    "checkErrorsMode" : 'بررسی خطاها',
    "navigateToUrl" : 'به این آدرس اینترنتی بروید',
    "completedHtml" : 'متن صفحه ی اتمام نظرسنجی',
    "completedHtmlOnCondition" : 'نمایش متن صفحه ی اتمام نظرسنجی به شرطی که',
    "navigateToUrlOnCondition" : 'رفتن به آدرس اینترنتی به شرطی که',
    "loadingHtml" : 'متنی که هنگام لود شدن نظر سنجی نمایش داده می شود',
    "completedBeforeHtml" : ' نشان دادن متنی که آیا کاربر قبلاً این نظرسنجی را پر کرده است یا خیر',
    "questionsOnPageMode" : 'نحوه ی قرارگیری سوالات در صفحه',
    "setToName" : 'سوال هدف',
    "autoComplete" : 'حالت تکمیل خودکار',
    "enableIf" : 'قابل ویرایش باشد اگر',
    "state" : 'حالت گسترش پانل',
    "indent" : 'تورفتگی از سر خط',
    "width" : 'عرض ( در css مورد قبول باشد)',
    "minWidth" : 'حداقل عرض ( در css مورد قبول باشد)',
    "maxWidth" : 'حداکثر عرض ( در css مورد قبول باشد)',
    "size" : 'تعداد کارکتر input',
    "hasComment" : 'نظرات نمایش داده شوند',
    "readOnly" : 'فقط بخواند',
    "page" : 'صفحه',
    "choicesFromQuestion" : 'انتخاب گزینه ها از سوالات مطرح شده',
    "maxSelectedChoices" : 'حداکثر تعداد انتخاب گزینه',
    "separateSpecialChoices" : 'جدا سازی گزینه های خاص( هیچ کدام، باقی گزینه ها، انتخاب همه)',
    "rateValues" : 'مقادیر رتبه بندی اختصاصی',
    "minImageWidth" : 'حداقل عرض عکس',
    "maxImageWidth" : 'حداکثر عرض عکس',
    "minImageHeight" : 'حداقل ارتفاع عکس',
    "maxImageHeight" : 'حداکثر ارتفاع عکس',
    "imageLinkName" : ' تهیه ی url عکس از فیلد json زیر',
    "labelTrue" : 'متن گزینه ی صحیح',
    "labelFalse" : 'متن گزینه ی غلط',
    "dataFormat" : ' فرمت تصویر',
    "rowsOrder" : ' ترتیب سطرها',
    "detailPanelMode" : 'محل قرارگیری جزییات پنل',
    "keyDuplicationError" : 'متن ارور تکراری بودن مقادیر',
    "choicesVisibleIf" : 'گزینه ها نمایش داده شوند اگر',
    "choicesEnableIf" : 'گزینه ها انتخاب شوند اگر',
  },
  "pv": {
    "true": "صحیح",
    "false": "غلط",
    ...
    "auto" : 'پیش فرض',
    "static" : 'ثابت',
    "responsive" : 'متناسب در همه ابعاد',
    "image" : 'عکس',
    "video" : 'فیلم',
    "contain" : 'عکس تناسب دارد (contain)',
    "cover" : 'عکس تناسب دارد و کامل جا میگیرد (cover)',
    "fill" : 'عکس  بدون تناسب تغییر اندازه می دهد (fill)',
    "underInput" : 'پایین ورودی',
    "underTitle" : 'پایین عنوان',
    "onBlur" : 'هنگامی که تار می شود',
    "onTyping" : 'در حال تایپ',
    "underRow" : 'پایین سطر',
    "underRowSingle" : 'پایین هر سطر',
    "pages" : 'صفحات',
    "questions" : 'سوالات',
    "requiredQuestions" : 'سوالات اجباری',
    "correctQuestions" : 'سوالات صحیح',
    "buttons" : 'دکمه ها',
    "selected" : 'انتخاب شده',
    "unSelected" : 'انتخاب نشده',
    "onValueChanging" : 'قبل از اینکه پاسخ سوال تغییر کند',
    "onHiddenContainer" : 'زمانی که سوال یا صفحه ی آن مخفی می شود',
    "display" : 'فقط خوانش (غیر قابل تغییر)',
    "never" : 'هرگز',
    "always" : 'همیشه'
  },
  "op": {
  ...
  "p": {
    ...
    "widthMode" : 'حالت ابعاد',
    "descriptionLocation" : 'موقعیت توضیحات',
    "defaultValueExpression" : 'عبارت مقدار پیش فرض',
    "minWidth" : 'حداقل عرض',
    "maxWidth" : 'حداکثر عرض',
    "clearIfInvisible" : 'اگر دیده نمی شد پاک شود',
    "autoComplete" : 'تکمیل خودکار',
    "choicesFromQuestion" : 'گزینه های موجود از سوال',
    "imageLinkName" : 'نام لینک تصویر',
    "dataList" : 'لیست داده ها',
    "maxSelectedChoices" : 'حداکثر گزینه های انتخاب شده',
    "labelTrue" : 'متن حالت صحیح',
    "labelFalse" : 'متن حالت غلط',
    "height" : 'ارتفاع',
    "penColor" : 'رنگ قلم',
    "backgroundColor" : 'رنک پس زمینه',
    "dataFormat" : ' نوع فایل داده',
    "rowsOrder" : 'ترتیب نمایش سطرها',
    "detailPanelMode" : 'حالت جزئیات پنل',
    "columnsVisibleIf" : 'ستون ها به شرطی آشکار باشند که',
    "rowsVisibleIf" : 'سطرها به شرطی آشکار باشند که',
    "rowTitleWidth" : 'طول عنوان هر سطر',
    "logoFit" : 'نحوه ی قرارگیری نمایه',
    "progressBarType" : 'نوع نوار پیشرفت',
    "questionDescriptionLocation" : 'محل قرار گیری توضیحات سوال',
    "questionTitlePattern" : 'الگوی عنوان سوال',
    "pages" : 'صفحات',
    "calculatedValues" : 'مقادیر محاسبه شده',
    "to" : 'به',
    "runExpression" : 'اجرای عبارت',
    "otherPlaceHolder" : 'عبارت اولیه',
    "choicesFromQuestionMode" : 'گزینه های دردسترس در این سوال',
    "commentPlaceHolder" : 'نمایش نظر اولیه',
    "showLabel" : 'نمایش متن عکس',
    "multiSelect" : 'امکان انتخاب چند گزینه'
  },
  "pel": {
    "isRequired": "اجباری؟"
  }
