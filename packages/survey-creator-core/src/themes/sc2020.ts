export default {
  ...
  "cssVariables": {
    ...
    "--sjs2-color-bg-brand-secondary-calculated": "rgba(from var(--sjs2-color-project-brand-600) r g b / var(--sjs2-opacity-x010))",
    "--sjs2-color-bg-brand-secondary-dim-calculated": "rgba(from var(--sjs2-color-project-brand-600) r g b / var(--sjs2-opacity-x015))",
    "--sjs2-color-bg-accent-secondary-calculated": "rgba(from var(--sjs2-color-project-accent-600) r g b / var(--sjs2-opacity-x010))",
    "--sjs2-color-bg-accent-secondary-dim-calculated": "rgba(from var(--sjs2-color-project-accent-600) r g b / var(--sjs2-opacity-x015))",

    "--sjs2-color-bg-brand-primary": "var(--sjs2-color-project-brand-600)",
    "--sjs2-color-bg-brand-secondary": "var(----sjs2-color-bg-brand-secondary-calculated, #19B3941A)",
    "--sjs2-color-bg-brand-primary-dim": "var(--sjs2-color-project-brand-700)",
    "--sjs2-color-bg-brand-secondary-dim": "var(--sjs2-color-bg-brand-secondary-dim-calculated, #14A48B)",
    "--sjs2-color-bg-accent-primary": "var(--sjs2-color-project-accent-600)",
    "--sjs2-color-bg-accent-secondary": "var(--sjs2-color-bg-accent-secondary-calculated, #FF98141A)",
    "--sjs2-color-bg-accent-primary-dim": "var(--sjs2-color-project-accent-700)",
    "--sjs2-color-bg-accent-secondary-dim": "var(--sjs2-color-bg-accent-secondary-dim-calculated, #FF981440)",
