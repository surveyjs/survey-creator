const Theme = {
  ...
  "cssVariables": {
    ...
    "--ctr-survey-action-button-padding-top": "var(--sjs-spacing-x1)",
    "--ctr-survey-action-button-padding-bottom": "var(--sjs-spacing-x1)",
    "--ctr-survey-action-button-icon-width": "var(--sjs-size-x3)",
    "--ctr-survey-action-button-icon-height": "var(--sjs-size-x3)",
    ...
    "--ctr-survey-action-button-padding-left-icon-only": "var(--sjs-spacing-x1)",
    "--ctr-survey-action-button-padding-right-icon-only": "var(--sjs-spacing-x1)",
