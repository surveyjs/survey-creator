export default {
  ...
  "cssVariables": {
    ...
    "--sjs2-color-utility-shadow-elevated-default": "rgba(from var(--sjs2-color-project-brand-600) r g b / var(--sjs2-opacity-x015))",
    ...
    "--sjs2-color-control-track-disabled-dot": "var(--sjs2-color-fg-basic-primary-disabled)",
