...
export const enStrings = {
  ...
  toolbox: {
    ...
    createItemTitle: "Create Toolbox Item",
    editCategoryTitle: "Edit Toolbox Category",
    createCategoryTitle: "Create Toolbox Category",
  ...
  propertyGrid: {
    ...
    createCategoryTitle: "Create Property Grid Category",
    editCategoryTitle: "Edit Property Grid Category",
  ...
  options: {
    ...
    o: {
      ...
      maxChoiceContentNestingLevel: "Maximum nesting depth for choice content",
    ...
    ohelp: {
      ...
      maxChoiceContentNestingLevel: "Specifies how deeply choice options in Radio Button Group and Checkboxes questions can contain nested survey content. Use 0 to disable nesting (default), or a positive number to set the maximum nesting depth.",
  ...
  plugin: {
    ...
    resetAll: "Discard all changes",
    resetConfirmation: "Discard all changes?",
    resetConfirmationMessage: "You will lose all unsaved changes",
    resetConfirmationOk: "Discard changes",
