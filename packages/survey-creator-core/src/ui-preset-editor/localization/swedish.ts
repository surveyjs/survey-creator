...
export const svStrings = {
  languages: {
    ...
    creatorUI: "Språk för användargränssnittet för skapare",
    ...
    translateToEnglish: "Översätt språknamn för undersökningar till engelska"
  },
  tabs: {
    // [Auto-translated] "Configure tabs"
    title: "Konfigurera flikar",
  ...
  toolbox: {
    ...
    addNewItem: "Lägg till ett nytt objekt",
  ...
  propertyGrid: {
    ...
    title: "Anpassa egenskapsrutnätet",
    ...
    description: "Välj ett element för att anpassa dess inställningar som är tillgängliga i egenskapsrutnätet.",
    // [Auto-translated] "Select an element to customize its settings available in the Property Grid"
  ...
  items: {
    ...
    moveToNewCategory: "Flytta till ny kategori...",
    // [Auto-translated] "Categories"
  ...
  plugin: {
    ...
    resetLanguages: "Återställ språk till standard",
    // [Auto-translated] "Reset all changes"
    resetAll: "Återställ alla ändringar",
    // [Auto-translated] "Reset {0} to defaults"
    resetToDefaults: "Återställa {0} till standardinställningarna"
  }
};
