...
// pehelp.itemTitleWidth: "Sets consistent width for all item labels. Accepts CSS values (px, %, in, pt, etc.)." => "Mengesetkan lebar yang konsisten untuk semua label item dalam piksel"
...
// p.itemTitleWidth: "Item label width" => "Lebar label item (dalam piksel)"
