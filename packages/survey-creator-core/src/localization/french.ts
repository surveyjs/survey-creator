...
var frenchTranslation = {
  ...
  pe: {
    ...
    focusOnFirstError: "Mettre le focus sur la réponse invalide",
    checkErrorsMode: "Lancer la validation",
    navigateToUrl: "Renvoyer vers la page",
    navigateToUrlOnCondition: "URL Dynamique",
    completedHtml: "Message de fin de questionnaire",
    completedHtmlOnCondition: "Message sous condition",
    completedBeforeHtml: "Message a afficher si l'utilisateur à déjà répondu au questionnaire",
    ...
    tabs: {
      ...
      cells: "Cellules",
      showOnCompleted: "Une fois Completer",
