...
export var enStrings = {
  ...
  ed: {
    ...
    lg: {
      ...
      question_resetValueText: "reset question value: {0}", //{0} question name
      question_setValueText: "set into question {0} value expression: {1}", //{0} question name and {1} setValueExpression
      ...
      column_resetValueText: "reset question cell value: {0}", //{0} question name
      column_setValueText: "set into question cell {0} value expression: {1}", //{0} question name and {1} setValueExpression
