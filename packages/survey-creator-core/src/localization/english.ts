...
export var enStrings = {
  ...
  ed: {
    ...
    pagePlaceHolderMobile: "Click the \"Add Question\" button below to add a new form element.",
    panelPlaceHolderMobile: "Click the \"Add Question\" button below to add a new form element.",
