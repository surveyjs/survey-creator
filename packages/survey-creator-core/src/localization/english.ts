...
export var enStrings = {
  ...
  ed: {
    ...
    lg: {
      ...
      panel_enableDescription: "Make the panel and all elements inside it enabled when the logic expression returns true. Otherwise keep them disabled.",
      ...
      trigger_setvalueDescription: "When question values used in the logic expression, are changed and the logic expression returns true, the value is set to the selected question.",
      trigger_copyvalueDescription: "When question values used in the logic expression are changed and the logic expression returns true, the value of one selected question is copied to another selected question.",
      trigger_skipDescription: "When the logic expression returns true, the survey skips to/focuses on the selected question.",
      trigger_runExpressionDescription: "When the logic expression returns true, the custom expression is performed. You may optionally set this expression result into the selected question",
      completedHtmlOnConditionDescription: "If the logic expression returns true, the default text for the \"Thank You\" page is changed to the given one.",
  ...
  pe: {
    ...
    allowClear: "Show the \"False\" button",
