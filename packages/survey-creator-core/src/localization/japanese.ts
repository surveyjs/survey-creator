...
export var jaStrings = {
  ...
  pe: {
    panel: {
      ...
      title: 'パネルタイトル',
      description: 'パネルの説明',
      visibleIf: 'パネルを表示する条件',
      requiredIf: 'パネルを必須にする条件',
      questionsOrder: 'パネル内の質問順序',
      page: '親ページ',
      startWithNewLine: '新しい行でパネルを表示',
      state: 'パネルの折りたたみ状態',
      width: 'インラインパネルの幅',
      minWidth: '最小パネル幅',
      maxWidth: '最大パネル幅',
    ...
    paneldynamic: {
      ...
      minWidth: '最小パネル幅',
      maxWidth: '最大パネル幅',
      confirmDelete: 'パネル削除の確認',
      templateDescription: 'パネル説明のパターン',
      templateTitle: 'パネルタイトルのパターン',
      noEntriesText: '空のパネルテキスト',
      templateTabTitle: 'タブタイトルのパターン',
      tabTitlePlaceholder: 'タブタイトルのプレースホルダー',
      templateVisibleIf: '個別のパネルを表示する条件',
      hideNumber: 'パネル番号を隠す',
      titleLocation: 'パネルタイトルの配置',
      descriptionLocation: 'パネル説明の配置',
      templateTitleLocation: '質問タイトルの配置',
      templateErrorLocation: 'エラーメッセージの配置',
      newPanelPosition: '新しいパネルの位置',
      showRangeInProgress: '進捗バーを表示',
      showProgressBar: 'プログレスバーを表示',
      progressBarLocation: 'プログレスバーの位置',
      keyName: '次の質問で重複回答を防ぐ',
    },
    question: {
      name: '質問名',
      title: '質問タイトル',
      description: '質問の説明',
      visibleIf: '質問を表示する条件',
      requiredIf: '質問を必須にする条件',
      page: '親ページ',
      state: '質問ボックスの折りたたみ状態',
      hideNumber: '質問番号を隠す',
      titleLocation: '質問タイトルの配置',
      descriptionLocation: '質問説明の配置',
      errorLocation: 'エラーメッセージの配置',
      indent: '内部インデントを増やす',
      width: 'インライン質問の幅',
      minWidth: '最小質問幅',
      maxWidth: '最大質問幅',
    ...
    signaturepad: {
      ...
      signatureAutoScaleEnabled: '署名領域の自動スケール',
      showPlaceholder: '署名領域内にプレースホルダーを表示',
      placeholder: 'プレースホルダーのテキスト',
      placeholderReadOnly: '読み取り専用またはプレビューモードのプレースホルダーテキスト',
      allowClear: '署名領域内にクリアボタンを表示',
    ...
    showQuestionNumbers: '質問番号',
    questionStartIndex: '質問開始インデックス',
    expression: {
      name: '式名',
      title: '式タイトル',
      description: '式の説明',
    ...
    page: {
      ...
      title: 'タイトル',
      description: 'ページの説明',
      visibleIf: 'ページを表示する条件',
      requiredIf: 'ページを必須にする条件',
      maxTimeToFinish: 'ページ完了の時間制限（秒）',
      questionsOrder: 'ページ上の質問順序',
    },
    matrixdropdowncolumn: {
      ...
      rows: '入力フィールドの高さ（行数）',
      visibleIf: '列を表示する条件',
      requiredIf: '列を必須にする条件',
      showInMultipleColumns: '各オプションを別の列に表示',
    },
    multipletextitem: {
      name: '名前',
      title: 'タイトル',
    ...
    masksettings: {
      saveMaskedValue: 'マスクされた値をアンケート結果に保存',
    },
    patternmask: {
      pattern: '値のパターン',
    },
    ...
    numericmask: {
      allowNegativeValues: '負の値を許可',
      thousandsSeparator: '1000単位の区切り文字',
      decimalSeparator: '小数点の区切り文字',
      precision: '値の精度',
      min: '最小値',
      max: '最大値',
    },
    ...
    cellErrorLocation: 'セルエラーメッセージの配置',
    enabled: '有効',
    disabled: '無効',
    inherit: '継承',
    apply: '適用',
    ...
    emptyValue: '値が空です',
    fastEntry: '手動入力',
    fastEntryNonUniqueError: "'{0}'の値は一意ではありません",
    fastEntryChoicesCountError: 'アイテム数を{0}から{1}に制限してください',
    fastEntryChoicesMinCountError: '少なくとも{0}個のアイテムを入力してください',
    fastEntryPlaceholder: '以下の形式でデータを設定できます：\n値1|テキスト\n値2',
    formEntry: 'フォーム入力',
    ...
    aceEditorHelp: '式の補完のヒントを得るにはctrl+spaceを押してください',
    aceEditorRowTitle: '現在の行',
    aceEditorPanelTitle: '現在のパネル',
    showMore: '詳細はドキュメントをご確認ください',
    assistantTitle: '利用可能な質問',
    cellsEmptyRowsColumns: '少なくとも1つの列または行が必要です',
    showPreviewBeforeComplete: '回答を送信する前にプレビューする',
    overridingPropertyPrefix: '設定者',
    resetToDefaultCaption: 'リセット',
    propertyIsEmpty: '値を入力してください',
    propertyIsNoUnique: '固有の値を入力してください',
    propertyNameIsNotUnique: '固有の名前を入力してください',
    propertyNameIsIncorrect: '予約語は使用しないでください: "item", "choice", "panel", "row".',
    listIsEmpty: '新しいアイテムを追加してください',
    'listIsEmpty@choices': '選択肢がまだ追加されていません',
    'listIsEmpty@columns': '列がまだありません',
    'listIsEmpty@rows': '行がまだありません',
    'listIsEmpty@validators': 'バリデーションルールがまだありません',
    'listIsEmpty@calculatedValues': 'カスタム変数がまだありません',
    'listIsEmpty@triggers': 'トリガーがまだありません',
    'listIsEmpty@navigateToUrlOnCondition': 'リンクがまだありません',
    'addNew@choices': '選択肢を追加',
    'addNew@columns': '列を追加',
    'addNew@rows': '行を追加',
    'addNew@validators': 'ルールを追加',
    'addNew@calculatedValues': '変数を追加',
    'addNew@triggers': 'トリガーを追加',
    'addNew@navigateToUrlOnCondition': 'URLを追加',
    expressionIsEmpty: '式が空です',
    value: '値',
    text: 'テキスト',
    rowid: '行ID',
    imageLink: '画像またはビデオファイルのURL',
    columnEdit: '列を編集: {0}',
    itemEdit: 'アイテムを編集: {0}',
    url: 'URL',
    path: 'パス',
    choicesbyurl: {
      url: 'WebサービスのURL',
      valueName: '次のプロパティから値を取得',
    },
    titleName: '次のプロパティから表示値を取得',
    imageLinkName: '次のプロパティからファイルURLを取得',
    allowEmptyResponse: '空の応答を許可',
    titlePlaceholder: 'タイトル',
    surveyTitlePlaceholder: 'アンケートタイトル',
    pageTitlePlaceholder: 'ページ {num}',
    descriptionPlaceholder: '説明',
    surveyDescriptionPlaceholder: '説明',
    pageDescriptionPlaceholder: '説明',
    showOtherItem: '「その他」オプションを有効にする',
    otherText: '「その他」オプションのテキスト',
    showNoneItem: '「なし」オプションを有効にする',
    noneText: '「なし」オプションのテキスト',
    showSelectAllItem: '「すべて選択」オプションを有効にする',
    selectAllText: '「すべて選択」オプションのテキスト',
    choicesMin: '自動生成アイテムの最小値',
    choicesMax: '自動生成アイテムの最大値',
    choicesStep: '自動生成アイテムのステップ値',
    name: '名前',
    title: 'タイトル',
    cellType: 'セル入力タイプ',
    colCount: '列数',
    ...
    visible: '表示',
    isRequired: '必須',
    isAllRowRequired: 'すべての行で回答必須',
    requiredErrorText: '必須質問のエラーメッセージ',
    startWithNewLine: '新しい行で質問を表示',
    rows: '行数',
    cols: '列',
    placeholder: '入力プレースホルダー',
    showPreview: 'プレビューエリアを表示',
    storeDataAsText: 'JSONの結果にファイルの内容をテキストとして保存',
    maxSize: '最大ファイルサイズ（バイト）',
    imageHeight: '画像の高さ',
    imageWidth: '画像の幅',
    rowCount: '行数',
    columnLayout: '列のレイアウト',
    addRowLocation: '行追加ボタンの位置',
    addRowText: '行追加ボタンのテキスト',
    removeRowText: '行削除ボタンのテキスト',
    rateMin: '最小レート値',
    rateMax: '最大レート値',
    rateStep: 'レートステップ',
    minRateDescription: '最小レートの説明',
    maxRateDescription: '最大レートの説明',
    inputType: '入力タイプ',
    optionsCaption: 'オプションのキャプション',
    defaultValue: 'デフォルト値',
    cellsDefaultRow: 'デフォルトセルテキスト',
    surveyEditorTitle: 'アンケート設定を編集',
    qEditorTitle: '編集: {0}',
    maxLength: '最大長',
    buildExpression: '構築',
    editExpression: '編集',
    ...
    remove: '削除',
    addCondition: '条件を追加',
    emptyLogicPopupMessage: '質問を選択して条件の設定を開始してください。',
    if: 'もし',
    then: 'その場合',
    setToName: '対象の質問',
    fromName: 'コピー元の質問',
    ...
    showTitle: 'タイトルを表示/非表示',
    expandCollapseTitle: 'タイトルの展開/折りたたみ',
    locale: 'デフォルト言語',
    simulator: 'デバイスタイプを選択',
    landscapeOrientation: '横向きに切り替え',
    portraitOrientation: '縦向きに切り替え',
    mode: 'モード（編集/読み取り専用）',
    clearInvisibleValues: '非表示の値をクリア',
    cookieName: 'Cookieの名前（ローカルで再度アンケートを実行しないようにするため）',
    sendResultOnPageNext: 'ページ切り替え時にアンケート結果を送信',
    storeOthersAsComment: '「その他」の値を別のフィールドに格納',
    showPageTitles: 'ページタイトルを表示',
    showPageNumbers: 'ページ番号を表示',
    pagePrevText: '「前のページ」ボタンのテキスト',
    pageNextText: '「次のページ」ボタンのテキスト',
    completeText: '「完了」ボタンのテキスト',
    previewText: '「プレビュー」ボタンのテキスト',
    editText: '「編集」ボタンのテキスト',
    startSurveyText: '「開始」ボタンのテキスト',
    showNavigationButtons: 'ナビゲーションボタンを表示（デフォルトナビゲーション）',
    showPrevButton: '「前のページ」ボタンを表示（ユーザーは前のページに戻ることができます）',
    firstPageIsStarted: 'アンケートの最初のページは開始ページです。',
    showCompletedPage: '完了ページを最後に表示（completedHtml）',
    goNextPageAutomatic: 'すべての質問に回答後、自動的に次のページに移動',
    showProgressBar: 'プログレスバーを表示',
    questionTitleLocation: '質問のタイトルの位置',
    requiredText: '必須シンボル（複数可）',
    questionStartIndex: '質問の開始インデックス（1、2または「A」、「a」）',
    showQuestionNumbers: '質問番号を表示',
    questionTitleTemplate: "質問のタイトルテンプレート。デフォルト値は: '{no}. {require} {title}'",
    questionErrorLocation: '質問エラーの位置',
    focusFirstQuestionAutomatic: 'ページ変更時に最初の質問にフォーカス',
    questionsOrder: 'ページ上の要素の順序',
    maxTimeToFinish: 'アンケート終了の制限時間（秒）',
    maxTimeToFinishPage: 'アンケートの1ページを終了する制限時間（秒）',
    showTimerPanel: 'タイマーパネルを表示',
    showTimerPanelMode: 'タイマーパネルモード',
    renderMode: 'パネルの表示モード',
    allowAddPanel: 'パネルの追加を許可',
    allowRemovePanel: 'パネルの削除を許可',
    panelAddText: 'パネル追加のテキスト',
    panelRemoveText: 'パネル削除のテキスト',
    isSinglePage: '1ページにすべての要素を表示',
    html: 'HTMLマークアップ',
    expression: '式',
    setValue: '回答',
    dataFormat: '画像フォーマット',
    allowAddRows: '行の追加を許可',
    allowRemoveRows: '行の削除を許可',
    allowRowsDragAndDrop: '行のドラッグアンドドロップを許可',
    responsiveImageSizeHelp: '正確な画像幅または高さを指定した場合は適用されません。',
    minImageWidth: '最小画像幅',
    maxImageWidth: '最大画像幅',
    minImageHeight: '最小画像高さ',
    maxImageHeight: '最大画像高さ',
    minValue: '最小値',
    maxValue: '最大値',
    minLength: '最小長',
    allowDigits: '数字を許可',
    ...
    totalType: '合計タイプ',
    totalExpression: '合計式',
    totalDisplayStyle: '合計値の表示スタイル',
    totalCurrency: '通貨',
    totalFormat: '書式設定された文字列',
    logo: 'ロゴ（URL または base64 でエンコードされた文字列）',
    questionsOnPageMode: 'アンケート構造',
    maxTextLength: '回答の最大長（文字数）',
    maxOthersLength: 'コメントの最大長（文字数）',
    autoGrowComment: '必要に応じてコメント領域を自動的に展開する',
    allowResizeComment: 'ユーザーがテキスト領域のサイズを変更できるようにする',
    textUpdateMode: 'テキスト質問値の更新',
    focusOnFirstError: '最初の無効な回答にフォーカスを設定する',
    checkErrorsMode: '検証の実行',
    navigateToUrl: 'URLへナビゲート',
    navigateToUrlOnCondition: '動的URL',
    completedBeforeHtml: 'ユーザーがすでにこのアンケートに記入しているかを示すマークアップ',
    completedHtml: 'アンケート完了ページのマークアップ',
    completedHtmlOnCondition: '動的アンケート完了ページのマークアップ',
    loadingHtml: 'アンケートモデルの読み込み中に表示するマークアップ',
    commentText: 'コメント領域のテキスト',
    autocomplete: 'オートコンプリートのタイプ',
    labelTrue: '「真」ラベル',
    labelFalse: '「偽」ラベル',
    allowClear: 'オプションのキャプションを表示',
    displayStyle: '値の表示スタイル',
    format: '書式設定された文字列',
    maximumFractionDigits: '小数部の最大桁数',
    minimumFractionDigits: '小数部の最小桁数',
    useGrouping: 'グループ化区切り文字を表示する',
    allowMultiple: '複数のファイルを許可',
    allowImagesPreview: 'プレビュー画像',
    acceptedTypes: '受け入れるファイルの種類',
    waitForUpload: 'アップロードが完了するのを待つ',
    needConfirmRemoveFile: 'ファイル削除の確認',
    detailPanelMode: '詳細パネルの位置',
    minRowCount: '最小行数',
    maxRowCount: '最大行数',
    confirmDelete: '行の削除を確認',
    confirmDeleteText: '確認メッセージ',
    panelCount: '初期パネル数',
    minPanelCount: '最小パネル数',
    maxPanelCount: '最大パネル数',
    panelsState: '内部パネルの展開状態',
    templateDescription: '説明テンプレート',
    templateTitle: 'タイトルテンプレート',
    panelPrevText: '前のパネルボタンのツールチップ',
    panelNextText: '次のパネルボタンのツールチップ',
    showRangeInProgress: 'プログレスバーを表示',
    templateTitleLocation: '質問タイトルの位置',
    panelRemoveButtonLocation: 'パネル削除ボタンの位置',
    hideIfRowsEmpty: '行がない場合は質問を非表示にする',
    hideColumnsIfEmpty: '行がない場合は列を非表示にする',
    rateValues: 'カスタムレート値',
    rateCount: 'レート数',
    autoGenerate: 'レート値の指定方法',
    hideIfChoicesEmpty: '選択肢がない場合は質問を非表示にする',
    hideNumber: '質問番号を非表示にする',
    minWidth: '最小幅（CSS対応の値）',
    maxWidth: '最大幅（CSS対応の値）',
    width: '幅（CSS対応の値）',
    showHeader: '列ヘッダーを表示',
    horizontalScroll: '水平スクロールバーを表示',
    columnMinWidth: '最小列幅（CSS対応の値）',
    rowTitleWidth: '行ヘッダー幅（CSS対応の値）',
    valueTrue: '「真」の値',
    valueFalse: '「偽」の値',
    minErrorText: '「値が最小値未満です」というエラーメッセージ',
    maxErrorText: '「値が最大値を超えています」というエラーメッセージ',
    otherErrorText: '「コメントを空にしてください」というエラーメッセージ',
    keyDuplicationError: '「キー値は一意でなければなりません」というエラーメッセージ',
    minSelectedChoices: '選択される最小の選択肢',
    maxSelectedChoices: '選択される最大の選択肢',
    showClear: '「クリア」ボタンを表示する',
    showNumber: 'パネル番号を表示する',
    logoWidth: 'ロゴの幅（CSS受け入れ値）',
    logoHeight: 'ロゴの高さ（CSS受け入れ値）',
    readOnly: '読み取り専用',
    enableIf: '次の場合に編集可能',
    ...
    displayRateDescriptionsAsExtremeItems: 'レートの説明を極値として表示',
    rowsOrder: '行の順序',
    ...
    choicesEnableIf: '選択肢は次の場合に選択可能です',
    ...
    titleKeyboardAdornerTip: '編集するためにエンターボタンを押してください',
    keyboardAdornerTip:
      'アイテムを編集するにはエンターボタンを押してください、アイテムを削除するにはdeleteボタンを押してください、アイテムを移動するにはalt + 上矢印キーまたは alt + 下矢印キーを押してください',
    triggerOn: 'オン ',
    triggerMakePagesVisible: 'ページを表示する:',
    triggerMakeQuestionsVisible: '要素を表示する:',
    triggerCompleteText: '成功した場合はアンケートを完了します。',
    triggerNotSet: 'トリガーが設定されていません',
    triggerRunIf: '次の場合に実行',
    triggerSetToName: '次の値を変更: ',
    triggerFromName: '次の値をコピー: ',
    triggerRunExpression: 'この式を実行:',
    triggerSetValue: '次に: ',
    triggerGotoName: '質問に移動:',
    triggerIsVariable: '変数をアンケート結果に入れないでください。',
    triggerRunExpressionEmpty: '有効な式を入力してください',
    emptyExpressionPlaceHolder: 'ここに式を入力してください...',
    noFile: 'ファイルが選択されていません',
    clearIfInvisible: '質問が非表示になった場合に値をクリアする',
    valuePropertyName: '値プロパティ名',
    searchEnabled: '検索を有効にする',
    hideSelectedItems: '選択されたアイテムを非表示にする',
    ...
    filePlaceholder: 'ファイルプレースホルダーテキスト',
    photoPlaceholder: '写真プレースホルダーテキスト',
    fileOrPhotoPlaceholder: 'ファイルまたは写真プレースホルダーテキスト',
    rateType: 'レートタイプ',
  },
  // Properties
  p: {
