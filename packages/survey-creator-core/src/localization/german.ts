...
var germanTranslation = {
  ...
  pe: {
    ...
    panelRemoveButtonLocation: "Entfernen Sie die Position der Bereich-Schaltfläche",
    ...
    state: "Erweiterungsstatus des Bereichs",
    correctAnswer: "Korrekte Antwort",
    defaultPanelValue: "Standard Werte",
    cells: "Zellen Texte",
    keyName: "Schlüssel Spalte",
    itemvalue: {
  ...
  p: {
    ...
    value: "Wert",
    visibleIf: "Sichtbar wenn ...",
    attachOriginalItems: "Originalartikel anhängen",
