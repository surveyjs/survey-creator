...
var germanTranslation = {
  ...
  pe: {
    ...
    logo: "Logo (URL oder base64-kodierte Zeichenfolge)",
    ...
    templateTitleLocation: "Ort des Fragetitels",
    panelRemoveButtonLocation: "Entfernen Sie die Position der Panel-Schaltfläche",
    ...
    minWidth: "Mindestbreite (in CSS-akzeptierten Werten)",
    ...
    rowTitleWidth: "Zeilenkopfbreite (in CSS-akzeptierten Werten)",
    valueTrue: "\"Wahr\" Wert",
    valueFalse: "\"Falsch\" Wert",
    minErrorText: "Fehlermeldung \"Wert liegt unter dem Minimum\"",
    ...
    showNumber: "Nummer im Bereich anzeigen",
    ...
    choicesFromQuestionMode: "Welche Optionen kopieren?",
    ...
    rowsOrder: "Reihenreihenfolge",
    columnsLayout: "Spaltenlayout",
    columnColCount: "Anzahl der verschachtelten Spalten",
    state: "Erweiterungsstatus des Panels",
    correctAnswer: "Korrekte Antwort",
    defaultPanelValue: "Standardwerte",
    cells: "Zellentexte",
    keyName: "Schlüsselspalte",
    itemvalue: {
      // text: "Alt text"
    },
    ...
    defaultValueFromLastPanel: "Übernehmen Sie die Standardwerte aus dem letzten Bereich",
  ...
  pv: {
    ...
    onHiddenContainer: "Wenn die Frage oder ihr Bereich/Seite ausgeblendet wird",
    ...
    panelsState: {
      default: "Benutzer können Bereiche nicht erweitern oder reduzieren",
      collapsed: "Alle Bereiche sind eingeklappt",
      expanded: "Alle Bereiche sind ausgeklappt"
    },
    widthMode: {
      // auto: "Auto",
      // static: "Static",
  ...
  pehelp: {
    ...
    totalText: "Nur sichtbar, wenn mindestens eine Spalte vom Typ „Gesamt“ oder „Gesamtausdruck“ ist.",
    acceptedTypes: "Weitere Informationen finden Sie in der Attributbeschreibung [accept](https://www.w3schools.com/tags/att_input_accept.asp).",
    columnColCount: "Gilt nur für die Zelltypen Radiogroup und Checkbox.",
    ...
    keyName: "Wenn die angegebene Spalte identische Werte enthält, gibt die Umfrage den Fehler \"Nicht eindeutiger Schlüsselwert\" aus"
  },
  // Properties
  p: {
    title: {
