...
// pehelp.itemTitleWidth: "Sets consistent width for all item labels. Accepts CSS values (px, %, in, pt, etc.)." => "Задава еднаква ширина за всички етикети на елементи в пиксели"
...
// p.itemTitleWidth: "Item label width" => "Ширина на етикета на елемента (в пиксели)"
