...
export var bgStrings = {
  ...
  p: {
    ...
    logoFit: "Подходящо за лого", // Auto-generated string
    pages: "Страници", // Auto-generated string
    questions: "Въпроси", // Auto-generated string
    triggers: "Тригери", // Auto-generated string
    calculatedValues: "Изчислени стойности", // Auto-generated string
    ...
    questionDescriptionLocation: "Местоположение на описанието на въпроса", // Auto-generated string
    progressBarType: "Тип лента за напредък", // Auto-generated string
    showTOC: "Показване на съдържание", // Auto-generated string
    tocLocation: "Местоположение на съдържанието", // Auto-generated string
    questionTitlePattern: "Шаблон на заглавието на въпроса", // Auto-generated string
    widthMode: "Режим на широчина", // Auto-generated string
    showBrandInfo: "Показване на информация за марката (бранда)", // Auto-generated string
    useDisplayValuesInDynamicTexts: "Стойности за показване на динамични текстове", // Auto-generated string
    visibleIf: "Видим, ако", // Auto-generated string
    titleLocation: "Местоположение на заглавието", // Auto-generated string
    descriptionLocation: "Описание на местоположението", // Auto-generated string
    defaultValueExpression: "Стойност по подразбиране на израза", // Auto-generated string
    requiredIf: "Задължителен, ако", // Auto-generated string
    validators: "Валидатори", // Auto-generated string
    ...
    choices: "Избори", // Auto-generated string
    ...
    isUnique: "Уникален", // Auto-generated string
    showInMultipleColumns: "Показване в няколко колони", // Auto-generated string
    ...
    detailPanelShowOnAdding: "Панелът с подробности се показва при добавяне.", // Auto-generated string
    ...
    dataList: "Списък с данни", // Auto-generated string
    itemSize: "Размер на елемента", // Auto-generated string
    elements: "Елементи", // Auto-generated string
    content: "Съдържание", // Auto-generated string
    navigationButtonsVisibility: "Видимост на бутоните за навигация", // Auto-generated string
    ...
    autoGrow: "Автоматичен растеж", // Auto-generated string
    allowResize: "Разреши преоразмеряване.",
    acceptCarriageReturn: "Приеми връщане на каретка.", // Auto-generated string
    displayMode: "Режим на показване", // Auto-generated string
    rateType: "Тип на оценката", // Auto-generated string
    label: "Етикет", // Auto-generated string
    contentMode: "Съдържателен режим", // Auto-generated string
    imageFit: "Напасване на изображението", // Auto-generated string
    altText: "Алтернативен текст", // Auto-generated string
    height: "Височина", // Auto-generated string
    penColor: "Цвят на писалката", // Auto-generated string
    backgroundColor: "Цвят на фона", // Auto-generated string
