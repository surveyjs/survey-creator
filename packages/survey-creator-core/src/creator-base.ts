...
export class SurveyCreatorModel extends Base
  ...
  onPropertyEditorCreatedCallback(object: any, property: JsonObjectProperty, editor: Question) {
    throw new Error("Method not implemented.");
  }
  onPropertyGridSurveyCreatedCallback(object: any, survey: SurveyModel) {
    throw new Error("Method not implemented.");
  }
  onPropertyEditorUpdateTitleActionsCallback(object: any, property: JsonObjectProperty, editor: Question, titleActions: IAction[]) {
    throw new Error("Method not implemented.");
  }
  onPropertyGridShowModalCallback(object: any, property: JsonObjectProperty, editor: Question, popupEditor: any, popupModel: PopupBaseViewModel) {
    throw new Error("Method not implemented.");
  }
  ...
  onItemValueAddedCallback(obj: Base, propertyName: string, itemValue: ItemValue, itemValues: Array<ItemValue>) {
    throw new Error("Method not implemented.");
  }
  onFastEntryCallback(items: Array<ItemValue>, lines: Array<string>): Array<ItemValue> {
    throw new Error("Method not implemented.");
  }
  onMatrixDropdownColumnAddedCallback(matrix: Question, column: MatrixDropdownColumn, columns: Array<MatrixDropdownColumn>) {
    throw new Error("Method not implemented.");
  }
  onSetPropertyEditorOptionsCallback(propertyName: string, obj: Base, editorOptions: any) {
    throw new Error("Method not implemented.");
  }
  ...
  uploadFiles(files: File[], question: Question, callback: (status: string, data: any) => any, context?: { element: Base, item?: any, elementType?: string, propertyName?: string }): void {
    throw new Error("Method not implemented.");
  }
  ...
  translationLocalesOrder: string[];
  isMobileView: boolean;
  alwaySaveTextInPropertyEditors: boolean;
  enableLinkFileEditor: boolean;
  rootElement?: HTMLElement;
