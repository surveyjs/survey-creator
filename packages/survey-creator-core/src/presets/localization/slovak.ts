...
export const skStrings = {
  languages: {
    ...
    creatorUI: "Jazyk používateľského rozhrania tvorcu",
    ...
    translateToEnglish: "Preložiť názvy jazykov prieskumu do angličtiny"
  },
  tabs: {
    // [Auto-translated] "Configure tabs"
    title: "Konfigurácia kariet",
  ...
  toolbox: {
    ...
    title: "Nastavenie aplikácie Toolbox",
    ...
    addNewItem: "Pridanie novej položky",
  ...
  propertyGrid: {
    ...
    title: "Prispôsobenie mriežky vlastností",
    ...
    description: "Vyberte prvok, ktorý chcete prispôsobiť jeho nastavenia, ktoré sú k dispozícii v mriežke vlastností.",
    // [Auto-translated] "Select an element to customize its settings available in the Property Grid"
  ...
  items: {
    ...
    moveToNewCategory: "Presunúť do novej kategórie...",
    // [Auto-translated] "Categories"
  ...
  plugin: {
    ...
    resetLanguages: "Obnoviť predvolené jazyky",
    // [Auto-translated] "Reset all changes"
    resetAll: "Obnoviť všetky zmeny",
    // [Auto-translated] "Reset {0} to defaults"
    resetToDefaults: "Obnoviť {0} na predvolené hodnoty"
  }
};
