...
export const heStrings = {
  languages: {
    ...
    creatorUI: "שפת ממשק המשתמש של היוצר",
    ...
    translateToEnglish: "תרגום שמות שפות הסקר לאנגלית"
  },
  tabs: {
    // [Auto-translated] "Configure tabs"
    title: "קביעת תצורה של כרטיסיות",
  ...
  propertyGrid: {
    ...
    title: "התאמה אישית של רשת המאפיינים",
    ...
    description: "בחר רכיב כדי להתאים אישית את ההגדרות שלו הזמינות ברשת המאפיינ��ם.",
    // [Auto-translated] "Select an element to customize its settings available in the Property Grid"
