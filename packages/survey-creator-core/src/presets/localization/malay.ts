...
export const msStrings = {
  languages: {
    ...
    translateToEnglish: "Terjemah nama bahasa Tinjauan ke bahasa Inggeris"
  },
  tabs: {
    // [Auto-translated] "Configure tabs"
    title: "Konfigurasikan tab",
  ...
  propertyGrid: {
    ...
    description: "Pilih elemen untuk menyesuaikan tetapannya yang tersedia dalam Grid Property.",
    // [Auto-translated] "Select an element to customize its settings available in the Property Grid"
  ...
  items: {
    ...
    moveToNewCategory: "Beralih ke kategori baru...",
    // [Auto-translated] "Categories"
  ...
  editor: {
    ...
    resetToDefault: "Tetapkan semula kepada lalai",
  ...
  plugin: {
    ...
    resetLanguages: "Tetapkan semula Bahasa kepada lalai",
    // [Auto-translated] "Reset all changes"
    resetAll: "Tetapkan semula semua perubahan",
    // [Auto-translated] "Reset {0} to defaults"
    resetToDefaults: "Tetapkan semula {0} kepada lalai"
  }
};
