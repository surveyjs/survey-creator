...
export const daStrings = {
  languages: {
    ...
    creatorUI: "Sprog i brugergrænsefladen for skabere",
    ...
    translateToEnglish: "Oversæt navne på undersøgelsessprog til engelsk"
  },
  tabs: {
  ...
  toolbox: {
    ...
    title: "Opsætning af værktøjskassen",
    ...
    addNewItem: "Tilføj et nyt element",
  ...
  propertyGrid: {
    ...
    title: "Tilpas egenskabsgitteret",
    ...
    description: "Vælg et element for at tilpasse dets indstillinger, der er tilgængelige i egenskabsgitteret.",
    // [Auto-translated] "Select an element to customize its settings available in the Property Grid"
  ...
  items: {
    ...
    moveToNewCategory: "Flyt til ny kategori...",
    // [Auto-translated] "Categories"
  ...
  plugin: {
    ...
    resetLanguages: "Nulstil sprog til standard",
    // [Auto-translated] "Reset all changes"
    resetAll: "Nulstil alle ændringer",
    // [Auto-translated] "Reset {0} to defaults"
    resetToDefaults: "Nulstil {0} til standardindstillinger"
  }
};
