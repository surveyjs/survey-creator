...
export const mnStrings = {
  languages: {
    ...
    translateToEnglish: "Судалгааны хэлний нэрсийг англи хэл рүү орчуул"
  },
  tabs: {
    // [Auto-translated] "Configure tabs"
    title: "Табуудыг тохируулах",
  ...
  toolbox: {
    ...
    addNewItem: "Шинэ зүйл нэмж оруул",
  ...
  propertyGrid: {
    ...
    title: "Property grid-ийг тохируулах",
    ...
    description: "Property Grid-д байгаа тохиргоог нь тохируулахын тулд элементийг сонго.",
    // [Auto-translated] "Select an element to customize its settings available in the Property Grid"
  ...
  items: {
    ...
    moveToNewCategory: "Шинэ ангилал руу шилжүүл...",
    // [Auto-translated] "Categories"
  ...
  editor: {
    ...
    resetToDefault: "Default руу reset",
  ...
  plugin: {
    ...
    resetLanguages: "Хэлнүүдийг default болгож өөрчлөх",
    // [Auto-translated] "Reset all changes"
    resetAll: "Бүх өөрчлөлтийг сэргээ",
    // [Auto-translated] "Reset {0} to defaults"
    resetToDefaults: "Стандарт {0}"
  }
};
