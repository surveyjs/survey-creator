...
export const itStrings = {
  languages: {
    ...
    creatorUI: "Lingua dell'interfaccia utente del creatore",
    ...
    translateToEnglish: "Traduci i nomi delle lingue del sondaggio in inglese"
  },
  tabs: {
    // [Auto-translated] "Configure tabs"
    title: "Configurare le schede",
  ...
  toolbox: {
    ...
    title: "Configurare la Casella degli strumenti",
    ...
    subitems: "Sottocategorie",
    // [Auto-translated] "Enable subitems for this question..."
    enableSubitems: "Abilita gli elementi secondari per questa domanda...",
    ...
    addNewItem: "Aggiungere un nuovo elemento",
  ...
  propertyGrid: {
    ...
    title: "Personalizzazione della griglia delle proprietà",
    ...
    description: "Selezionare un elemento per personalizzarne le impostazioni disponibili nella Griglia delle proprietà.",
    // [Auto-translated] "Select an element to customize its settings available in the Property Grid"
  ...
  items: {
    ...
    moveToNewCategory: "Passa alla nuova categoria...",
    // [Auto-translated] "Categories"
  ...
  plugin: {
    ...
    resetLanguages: "Ripristina le lingue ai valori predefiniti",
    // [Auto-translated] "Reset all changes"
    resetAll: "Ripristina tutte le modifiche",
    // [Auto-translated] "Reset {0} to defaults"
    resetToDefaults: "Ripristina {0} ai valori predefiniti"
  }
};
