...
export var settings = {
  ...
  operators: {
    ...
    equal: ["!file"],
    notequal: ["!file"],
    contains: ["checkbox", "text", "comment", "imagemap"],
    notcontains: ["checkbox", "text", "comment", "imagemap"],
    anyof: ["selectbase", "imagemap"],
    noneof: ["selectbase", "imagemap"],
    allof: ["checkbox", "imagemap"],
    greater: ["!checkbox", "!imagepicker", "!boolean", "!file", "!imagemap"],
    less: ["!checkbox", "!imagepicker", "!boolean", "!file", "!imagemap"],
    greaterorequal: ["!checkbox", "!imagepicker", "!boolean", "!file", "!imagemap"],
    lessorequal: ["!checkbox", "!imagepicker", "!boolean", "!file", "!imagemap"]
  },
