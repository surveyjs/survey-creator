...
const defaultProperties: ISurveyPropertiesDefinition = {
  question: {
    properties: [
      ...
      "commentText",
      "commentPlaceholder",
      { name: "visibleIf", tab: "logic", index: 800 },
      { name: "enableIf", tab: "logic", index: 700 },
      { name: "requiredIf", tab: "logic", index: 600 },
      { name: "bindings", tab: "logic", index: 500 },
      { name: "defaultValueExpression", tab: "logic", index: 400 },
      { name: "resetValueIf", tab: "logic", index: 300 },
      { name: "setValueIf", tab: "logic", index: 200 },
      { name: "setValueExpression", tab: "logic", index: 100 },
  ...
  slider: {
    properties: [
      ...
      { name: "minValueExpression", tab: "logic", index: 610 },
      { name: "maxValueExpression", tab: "logic", index: 620 },
    ],
