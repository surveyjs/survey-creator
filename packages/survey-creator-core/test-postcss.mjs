...
// setups) without warnings. Mirrors survey-core's test-postcss.mjs.
//
...
const cssPath = new URL("./build/survey-creator-core.css", import.meta.url);
...
if (failures.length > 0) {
  console.error(`test:postcss: ${failures.length} warning(s) in build/survey-creator-core.css:`);
