...
const defaultComputedCssVariables: Record<string, string> = {
  ...
  "--sjs2-typography-font-family-component-survey-header-title": "Open Sans",
  "--sjs2-typography-font-family-component-survey-header-description": "Open Sans",
  "--sjs2-typography-font-weight-component-survey-header-title": "700",
  "--sjs2-typography-font-weight-component-survey-header-description": "400",
  "--sjs2-typography-font-size-component-survey-header-title": "32px",
  "--sjs2-typography-font-size-component-survey-header-description": "20px",
  "--sjs2-typography-line-height-component-survey-header-title": "40px",
  "--sjs2-typography-line-height-component-survey-header-description": "32px",
