...
test("Designer widthMode css test", () => {
  ...
  expect(designerPlugin.model.designerCss).toEqual("svc-designer-surface sd-theme-root sjs-theme-overrides sd-container-modern sd-container-modern--static");
  creator.survey.getQuestionByName("question2").startWithNewLine = false;
  expect(designerPlugin.model.designerCss).toEqual("svc-designer-surface sd-theme-root sjs-theme-overrides sd-container-modern sd-container-modern--responsive");
