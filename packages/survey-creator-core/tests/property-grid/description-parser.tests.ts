...
test("Test markdown by multipl;e feature", () => {
  expect(parsePropertyDescription("fdfs[aaa](bbb_cc_dd)fjdkslfj")).toEqual("fdfs<a class='spg-link' href='bbb_cc_dd'>aaa</a>fjdkslfj");
  expect(parsePropertyDescription("Refer to the [accept](https://www.w3schools.com/tags/att_input_accept.asp) attribute description for more information.")).
    toEqual("Refer to the <a class='spg-link' href='https://www.w3schools.com/tags/att_input_accept.asp'>accept</a> attribute description for more information.");
});