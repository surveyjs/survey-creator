  ...
  render(): React.JSX.Element {
    const banner = (this.props.isCompact ?
      <span className="svc-toolbox__item-banner"
        ...
        <SvgIcon title={this.item.title} size={"auto"} iconName={this.item.iconName} className="svc-toolbox__item-icon"></SvgIcon>
    ...
    const item = attachKey2click(
      ...
      >
        <span className="svc-toolbox__item-container">
          {!!this.item.iconName ? <SvgIcon title={this.item.title} size={"auto"} iconName={this.item.iconName} className="svc-toolbox__item-icon"></SvgIcon> : null}
        </span>
