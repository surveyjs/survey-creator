...
const banner = [
  "SurveyJS Creator Presets UI v" + packageJson.version,
...
module.exports = function (options) {
  ...
  const config = {
    ...
    entry: {
      "survey-creator-js-presets": path.resolve(__dirname, "./entries/presets.ts")
    },
    resolve: {
    ...
    externals: {
      ...
      "survey-creator-js": {
        root: "SurveyCreator",
        commonjs2: "survey-creator-js",
        commonjs: "survey-creator-js",
        amd: "survey-creator-js"
      }
