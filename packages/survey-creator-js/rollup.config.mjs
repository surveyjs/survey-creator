...
const buildPlatformJson = {
  name: pkg.name,
  version: pkg.version,
  description: "HTML/CSS/JavaScript component that renders SurveyJS Survey Creator: a white-label drag-and-drop form builder producing JSON schemas with validation, conditional logic, localization, and theming. No frontend framework required.",
