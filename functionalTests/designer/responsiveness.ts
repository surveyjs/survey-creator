...
//     .expect(creatorFooterToolbarActions.nth(0).hasClass("sv-action--svd-designer")).eql(true)
//     .expect(creatorFooterToolbarActions.nth(1).hasClass("sv-action--svd-preview")).eql(true)
//     .expect(creatorFooterToolbarActions.nth(2).hasClass("sv-action--showInvisible")).eql(true)
...
//     .expect(creatorFooterToolbarActions.nth(2).hasClass("sv-action--prevPage")).eql(true)
//     .expect(creatorFooterToolbarActions.find(".svc-preview-pager__item").nth(0).hasAttribute("disabled")).eql(true)
//     .expect(creatorFooterToolbarActions.nth(3).hasClass("sv-action--nextPage")).eql(true)
//     .expect(creatorFooterToolbarActions.find(".svc-preview-pager__item").nth(1).hasAttribute("disabled")).eql(false)
//     .expect(creatorFooterToolbarActions.nth(4).hasClass("sv-action--showInvisible")).eql(true)
