---
title: How to Design an Image-Based Survey
description: Make your survey or form more engaging compared to forms with traditional text-based questions. Add videos and images as answer choices. Use the image picker to present respondents with a set of media files to choose from.
---

# How to Design an Image-Based Survey

## About questions that use videos and images as answers
...
SurveyJS Form Builder offers two question types that allow form designers to create surveys that only uses images for answers&mdash;Image Picker and Image.
...
## How to Create a Question that Shows Images as Answers
...
## How to Create a Question that Shows Videos as Answers

To create a question that would allow respondents to select one or several videos options, follow these steps:
...
If you want to provide information more accurately than you can with a purely text-based question, you can add an image or a video to your form, and then add a few follow-up questions underneath. This method is also suitable for picture-based surveys that require respondents to interpret images without selecting from predefined choices.
