...
<img src="images/eud-expression-settings.png" alt='Survey Creator: Expression builder UI' width="1544" height="732">
...
<img src="images/eud-visibleif-expression.png" alt='How to specify a conditional visibility expression' width="1544" height="732">
...
<img src="images/eud-inputype-date.png" alt='How to specify input type' width="1544" height="732">
...
<img src="images/eud-questionname.png" alt='How to specify question name' width="1544" height="732">

7. Select the `end-date` question, locate the **Validation rules** setting under the **Validation** category, and click **Add new rule**.

<img src="images/eud-validationrules-addnewrule.png" alt='How to add a new data validation rule' width="1544" height="692">

8. Enter the following validation expression in the **Valid when** editor: `{panel.start-date} < {panel.end-date}`.
9. Specify the following **Notification message for invalid input**: `End date should be greater than start date`.

<img src="images/eud-validationrules-expression.png" alt='A data validation rule of the expression type' width="1544" height="702">
...
<img src="images/eud-datevalidation-preview.png" alt='Date validation preview' width="1544" height="696">
...
4. Enter the following validation expression in the **Valid when** field: `dateDiff({start-date}, {end-date}, "days") <= 14`.
5. Specify the following **Notification message for invalid input**: `Difference between start and end dates must not be greater than 14 days`.

<img src="images/eud-validation-datediff.png" alt='A validation rule that checks the difference between two dates' width="1544" height="690">

To verify the validation, open the Preview tab and select two dates that are more than 14 days apart.

<img src="images/eud-validation-datediff-preview.png" alt='Date difference validation preview' width="1544" height="518">
