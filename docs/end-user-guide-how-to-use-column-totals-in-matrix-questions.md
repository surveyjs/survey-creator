...
<img src="images/eud-total-days.png" alt="Dynamic Matrix: How to aggregate data in a column" width="1544" height="820">
...
<img src="images/eud-aggregation-methods.png" alt="Dynamic Matrix: Data aggregation methods" width="1544" height="650">
...
3. In the **General** category, locate the **Cell input type** property and set it to **Expression (read-only)**.
...
<img src="images/eud-expression-column.png" alt="Dynamic Matrix: How to use the duration function to calculate the number of days between two dates" width="1544" height="752">

5. In the **Totals** category, locate the **Aggregation method** property and select the desired method.
...
<img src="images/eud-column-total.png" alt="Dynamic Matrix: How to add the Total value for a column" width="1544" height="752">
...
<img src="images/eud-currency.png" alt="Dynamic Matrix: How to set the currency for the total value of a matrix column" width="1544" height="684">

The resulting value will look as follows:

<img src="images/eud-usd.png" alt="Dynamic Matrix: How to sum up values within a column and add a currency sign to the total" width="1544" height="580">
