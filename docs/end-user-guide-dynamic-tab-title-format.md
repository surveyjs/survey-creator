...
<img src="../images/eud-panel-display-mode 442 713.png" alt="Dynamic Panel: Entry display mode" width="332" height="535">
...
<img src="../images/eud-panel-count 443 327.png" alt="Entry count properties" width="332" height="245">
...
<img src="../images/eud-numbering 895 562.png" alt="Entry numbering format" width="895" height="562">
...
3. Decide a response to which question you want to use as a dynamic entry title.
...
5. Make the question **Required** to make sure it receives an answer.<br><br>
    <img src="../images/eud-dynamic-panel-setup 1583 795.png" alt="Dynamic entry tab titles" width="1583" height="795">
...
9. Optionally, align the tab title to the left, center, or right using the **Tab alignment** property.<br><br>
    <img src="../images/eud-tab-title-pattern 1580 784.png" alt="How to align dynamic entry tab titles" width="1580" height="784">
