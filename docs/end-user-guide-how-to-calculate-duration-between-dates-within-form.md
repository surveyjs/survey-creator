...
<img src="images/eud-set-value-expression.png" alt='Set value expression in a Single-Line Input' width="1544" height="686">
...
<img src="images/eud-read-only.png" alt='How to set Read-only mode for a Single-Line Input' width="1544" height="698">

### Expression

This question is always read-only. The value is set using the **Expression** property located under **General**:

<img src="images/eud-expression-property.png" alt='Expression property in an Expression question' width="1544" height="698">
...
<img src="images/eud-outcome.png" alt='How to calculate duration between two date fields in a form' width="1544" height="534">
...
<img src="images/eud-expression-outcome.png" alt='An Expression question that calculates and displays duration between two other date fields' width="912" height="598">
...
2. Under **General**, locate the **Expression** field.
3. Enter the following sample value: `dateDiff({since-date}, today(), 'years') + ' years' + ' ' + dateDiff({since-date}, today(), 'months') % 12 + ' months'`.
4. Under **Conditions**, locate the **Make the question visible if** property.
5. Click the **Magic wand icon** on the right of the property.
6. Set up a visibility rule by selecting the ID of the source question for the start date. Based on the configuration below, the Expression question will only be visible once the question with an ID `since-date` receives a date value, i.e., when it is not empty.

<img src="images/eud-expression-visibility.png" alt='How to set up a visibility rule for an Expression question' width="1544" height="638">
...
<img src="images/eud-single-line-outcome.png" alt='How to set an expression-based value for a Single-Line Input question' width="1544" height="534">
...
<img src="images/eud-set-value-if-and-set-value-expression.png" alt='How to set and condition an expression-based value for a Single-Line Input' width="1544" height="640">
