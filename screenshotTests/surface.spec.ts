...
test.describe(title, () => {
  ...
  test("Test question type converter", async ({ page }) => {
    ...
    await page.locator(".svc-dropdown-action--convertTo").first().waitFor({ state: "visible" });
    await page.locator(".svc-dropdown-action--convertTo").first().click();
  ...
  test("Test question type selector", async ({ page }) => {
    ...
    await page.click(".svc-page__footer .svc-add-new-question-action .svc-surface-btn .svc-surface-btn__selector .sd-action");
  ...
  test("Check adorner actions responsivity after convert", async ({ page }) => {
    ...
    await page.locator(".svc-dropdown-action--convertTo").nth(4).click();
