...
test.describe(title, () => {
  ...
  test("Check property grid flyout", async ({ page }) => {
    ...
    const root = page.locator(".svc-creator");
    await setJSON(page, {});
    await page.click('[data-sv-drop-target-survey-element="survey"]');
  ...
  test("Logo image adorners", async ({ page }) => {
    ...
    const json = {
      showQuestionNumbers: "on",
      logo: "data:image/svg+xml,%3Csvg height='100%25' width='100%25' viewBox='0 0 162 66' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M161.579 0H0.420532V50.1402H143.407L161.579 66V0Z' fill='%2319B394'%3E%3C/path%3E%3C/svg%3E",
      elements: [
        {
          type: "text",
          name: "q1"
