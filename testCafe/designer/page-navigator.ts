...
test("Check page navigator track scrolling", async (t) => {
  ...
  const firstPageNavigatorItem = "svc-page-navigator-item:nth-of-type(2) > .svc-page-navigator-item--selected, .svc-page-navigator-item:nth-of-type(2) > .svc-page-navigator-item--selected";
  const lastPageNavigatorItem = "svc-page-navigator-item:nth-of-type(5) > .svc-page-navigator-item--selected, .svc-page-navigator-item:nth-of-type(5) > .svc-page-navigator-item--selected";
