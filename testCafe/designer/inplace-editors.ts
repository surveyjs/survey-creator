...
test("Checkbox question inplace editor", async (t) => {
  await t
    ...
    .expect(items.nth(0).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
    .hover(items.nth(0))
    .expect(items.nth(0).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
    ...
    .expect(items.nth(1).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
    .hover(items.nth(1))
    .expect(items.nth(1).find(".svc-item-value-controls__drag .sv-svg-icon").visible).ok()
    ...
    .expect(items.nth(2).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
    .hover(items.nth(2))
    .expect(items.nth(2).find(".svc-item-value-controls__drag .sv-svg-icon").visible).ok()
    ...
    .expect(items.nth(3).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
    .hover(items.nth(3))
    .expect(items.nth(3).find(".svc-item-value-controls__drag .sv-svg-icon").visible).ok()
    ...
    .expect(items.nth(4).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
    .hover(items.nth(4))
    .expect(items.nth(4).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
    ...
    .expect(items.nth(5).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
    .hover(items.nth(5))
    .expect(items.nth(5).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
    ...
    .expect(items.nth(6).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
    .hover(items.nth(6))
    .expect(items.nth(6).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
    ...
    .hover(items.nth(4))
    .expect(items.nth(4).find(".svc-item-value-controls__drag .sv-svg-icon").visible).ok()
    .expect(items.nth(5).hasClass("svc-item-value--new")).ok()
    .expect(items.nth(5).find(".svc-item-value-controls__add").visible).ok()
    .expect(items.nth(5).find(".svc-item-value-controls__remove").visible).notOk()
    .expect(items.nth(5).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
...
test("Radiogroup question inplace editor", async (t) => {
  await t
    ...
    .expect(items.nth(0).find(".svc-item-value-controls__drag .sv-svg-icon").visible).notOk()
    .hover(items.nth(0))
    .expect(items.nth(0).find(".svc-item-value-controls__drag .sv-svg-icon").visible).ok()
