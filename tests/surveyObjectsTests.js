...
(function (SurveyObjectEditorTests) {
    ...
    (function (Tests) {
        ...
        QUnit.test("Triggers property editor", function (assert) {
            ...
            var result = [];
            var propEditor = new SurveyEditor.SurveyPropertyTriggers(function (newValue) { result = newValue; });
        ...
        QUnit.test("Validators property editor", function (assert) {
            ...
            var result = [];
            var propEditor = new SurveyEditor.SurveyPropertyValidators(function (newValue) { result = newValue; });
